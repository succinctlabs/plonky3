...
mod tests {
    ...
    type Perm = Poseidon2<F, ExternalMatrixBabybear, DiffusionMatrixBabybear, 16, 5>;
    ...
    fn commit_single_1x8() {
        let ext = ExternalMatrixBabybear::default();
        let perm = Perm::new_from_rng(8, 22, ext, DiffusionMatrixBabybear, &mut thread_rng());
